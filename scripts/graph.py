...
from scripts.cryptocurrencies_prices import crypto_currencies_prices as ccp, CRYPTOCURRENCIES_SYMBOLS
...
class Graph:
    ...
    def update(self, settings: list) -> None:
        ...
        y_title = 'price (in {})'.format(CRYPTOCURRENCIES_SYMBOLS[physical])
